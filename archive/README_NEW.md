...
# With custom options
python main.py --input-dir my_input --output my_output.html --mock-llm
...
The tool generates an HTML file with citation evaluations inserted after each referenced div:
...
| `OUTPUT_FILE` | `content_reviewed.html` | Output file path |
