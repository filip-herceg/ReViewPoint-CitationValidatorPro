...
class SourceContentSimulator:
    ...
    def simulate_source_content(self, citation: Dict[str, Any]) -> str:
        ...
        """
        logger.debug(f"Simulating content for citation: "
        ...
        content_index = hash(
            citation.get('doi', citation.get('title', ''))
        ) % len(content_list)
    ...
    def _classify_citation(self, citation: Dict[str, Any]) -> str:
        ...
        ai_keywords = ['chatbot', 'conversational', 'ai', 
        ...
        privacy_keywords = ['privacy', 'security', 'data protection', 
                           'enterprise']
